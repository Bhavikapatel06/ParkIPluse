  ...
  const handleExportPDF = (reportType) => {
    ...
    try {
      ...
      if (reportType === 'executive') {
        ...
        let y = 75;
        doc.text('This report summarizes the operational metrics and traffic violation outcomes within the city limits, providing an analytics overview to assist traffic marshals and operations commanders in data-driven scheduling.', 14, y);
        y += 15;
        ...
        let y = 75;
        doc.text('This details spatial density clustering mapped via the DBSCAN clustering model, highlighting regions with critical vehicle congestion patterns.', 14, y);
        y += 15;
        ...
        let y = 75;
        doc.text('This report outlines congestion prediction metrics generated by the machine learning engine using Random Forest Regressors.', 14, y);
        y += 15;
